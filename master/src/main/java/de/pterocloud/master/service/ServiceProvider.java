...
public class ServiceProvider {
    ...
    private ArrayList<Service> serviceRegistry;
    ...
    public Service getService(Class sevice,String id){
        for (Service s : serviceRegistry){
            if (s.getClass().getName().equals(sevice.getName()) && s.getInternalServiceId().equals(id)){
                return s;
            }
        }
        return null;
